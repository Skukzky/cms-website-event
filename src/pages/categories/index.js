...
import ComponentBreadCrumb from '../../components/BreadCrumb/index';
...
function Categories() {
  ...
  return (
    <Container className="mt-3">
      <ComponentBreadCrumb textSecond={'Categories'} />

      {access.tambah && (
        <Button className={'mb-3'} onClick={() => navigate('/categories/create')}>
          Tambah
        </Button>
      )}
