...
function EventPage() {
  ...
  return (
    <Container className="mt-3">
      <Button onClick={() => navigate('/events/create')}>Tambah</Button>
      <ComponentBreadCrumb textSecond={'Events'} />
      <Row>
        <Col>
      ...
      <Table
        ...
        customAction={(id, status = '') => {
          return (
            <Button className={'mx-2'} variant="primary" size={'sm'} onClick={() => handleChangeStatus(id, status)}>
              Change Status
            </Button>
          );
        }}
